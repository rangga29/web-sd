...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="{{ strip_tags(Illuminate\Support\Str::limit($post->content, 150)) }}">
    <meta name="keywords" content="{{ $setting->meta_keywords }}" />
    <meta name="robots" content="all" />
    <meta name="author" content="{{ $setting->meta_author }}">
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:title" content="{{ $title }}">
    <meta name="twitter:description" content="{{ strip_tags(Illuminate\Support\Str::limit($post->content, 150)) }}">
    <meta name="twitter:image" content="{{ asset('upload/' . $post->image) }}" />
    <meta property="og:title" content="{{ $title }}" />
    <meta property="og:description" content="{{ strip_tags(Illuminate\Support\Str::limit($post->content, 150)) }}" />
    <meta property="og:image" content="{{ asset('upload/' . $post->image) }}" />
