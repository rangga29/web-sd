...
class HomepageController extends Controller
{
    ...
    {
        $title = 'SD Santa Ursula Bandung | Profil Sekolah';
        $setting = GeneralSetting::where('id', 1)->first();
        $links = Link::orderBy('id', 'asc')->get();
        $post_categories = PostCategory::orderBy('slug', 'asc')->get();
        $post_authors = User::role('Author')->orderBy('name', 'asc')->get();
    ...
    {
        $title = 'SD Santa Ursula Bandung | Sejarah Sekolah';
        $setting = GeneralSetting::where('id', 1)->first();
        $links = Link::orderBy('id', 'asc')->get();
        $post_categories = PostCategory::orderBy('slug', 'asc')->get();
        $post_authors = User::role('Author')->orderBy('name', 'asc')->get();
    ...
    {
        $title = 'SD Santa Ursula Bandung | Visi & Misi';
        $setting = GeneralSetting::where('id', 1)->first();
        $links = Link::orderBy('id', 'asc')->get();
        $post_categories = PostCategory::orderBy('slug', 'asc')->get();
        $post_authors = User::role('Author')->orderBy('name', 'asc')->get();
    ...
    {
        $title = 'SD Santa Ursula Bandung | 6 Nilai Serviam';
        $setting = GeneralSetting::where('id', 1)->first();
        $links = Link::orderBy('id', 'asc')->get();
        $post_categories = PostCategory::orderBy('slug', 'asc')->get();
        $post_authors = User::role('Author')->orderBy('name', 'asc')->get();
    ...
    {
        $title = 'SD Santa Ursula Bandung | Entrepreneurship';
        $setting = GeneralSetting::where('id', 1)->first();
        $links = Link::orderBy('id', 'asc')->get();
        $post_categories = PostCategory::orderBy('slug', 'asc')->get();
        $post_authors = User::role('Author')->orderBy('name', 'asc')->get();
    ...
    {
        $title = 'SD Santa Ursula Bandung | Fasilitas';
        $setting = GeneralSetting::where('id', 1)->first();
        $links = Link::orderBy('id', 'asc')->get();
        $post_categories = PostCategory::orderBy('slug', 'asc')->get();
        $post_authors = User::role('Author')->orderBy('name', 'asc')->get();
    ...
    {
        $title = 'SD Santa Ursula Bandung | Berita & Artikel';
        $setting = GeneralSetting::where('id', 1)->first();
        $links = Link::orderBy('id', 'asc')->get();
        $post_categories = PostCategory::orderBy('slug', 'asc')->get();
        $post_authors = User::role('Author')->orderBy('name', 'asc')->get();
    ...
    {
        $title = 'SD Santa Ursula Bandung | ' . $post_category->name;
        $setting = GeneralSetting::where('id', 1)->first();
        $links = Link::orderBy('id', 'asc')->get();
        $post_categories = PostCategory::orderBy('slug', 'asc')->get();
        $post_authors = User::role('Author')->orderBy('name', 'asc')->get();
    ...
    public function postsByAuthor($slug)
    {
        ...
        $title = 'SD Santa Ursula Bandung | ' . $author->name;
        $setting = GeneralSetting::where('id', 1)->first();
        $links = Link::orderBy('id', 'asc')->get();
        $post_categories = PostCategory::orderBy('slug', 'asc')->get();
        $post_authors = User::role('Author')->orderBy('name', 'asc')->get();
    ...
    {
        $title = 'SD Santa Ursula Bandung | ' . $post->title;
        $setting = GeneralSetting::where('id', 1)->first();
        $links = Link::orderBy('id', 'asc')->get();
        $post_categories = PostCategory::orderBy('slug', 'asc')->get();
        $post_authors = User::role('Author')->orderBy('name', 'asc')->get();
    ...
    {
        $title = 'SD Santa Ursula Bandung | Galeri Foto';
        $setting = GeneralSetting::where('id', 1)->first();
        $links = Link::orderBy('id', 'asc')->get();
        $post_categories = PostCategory::orderBy('slug', 'asc')->get();
        $post_authors = User::role('Author')->orderBy('name', 'asc')->get();
    ...
    {
        $title = 'SD Santa Ursula Bandung | ' . $gallery_category->name;
        $setting = GeneralSetting::where('id', 1)->first();
        $links = Link::orderBy('id', 'asc')->get();
        $post_categories = PostCategory::orderBy('slug', 'asc')->get();
        $post_authors = User::role('Author')->orderBy('name', 'asc')->get();
    ...
    {
        $title = 'SD Santa Ursula Bandung | ' . $gallery->title;
        $setting = GeneralSetting::where('id', 1)->first();
        $links = Link::orderBy('id', 'asc')->get();
        $post_categories = PostCategory::orderBy('slug', 'asc')->get();
        $post_authors = User::role('Author')->orderBy('name', 'asc')->get();
    ...
    {
        $title = 'SD Santa Ursula Bandung | ' . $school_activity->title;
        $setting = GeneralSetting::where('id', 1)->first();
        $links = Link::orderBy('id', 'asc')->get();
        $post_categories = PostCategory::orderBy('slug', 'asc')->get();
        $post_authors = User::role('Author')->orderBy('name', 'asc')->get();
    ...
    {
        $title = 'SD Santa Ursula Bandung | Kontak Sekolah';
        $setting = GeneralSetting::where('id', 1)->first();
        $links = Link::orderBy('id', 'asc')->get();
        $post_categories = PostCategory::orderBy('slug', 'asc')->get();
        $post_authors = User::role('Author')->orderBy('name', 'asc')->get();
    ...
    public function kirimPesan(Request $request)
    {
        ...
        Mail::to('sd@santaursula-bdg.sch.id')->send(new ContactMail($mailData, $validateData['email'], $validateData['name'], $validateData['name']));
